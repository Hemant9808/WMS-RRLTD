          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 border rounded-lg">
              <div className='relative py-2 flex flex-col'>
                              <Label className="text-sm ml-2 text-gray-500 font-medium">Upload Vendor Photo</Label>
            ...
            <div className="space-y-2">
              ...
              <div className="text-sm mb-3 text-gray-700 font-semibold ">Primary Details</div>


              <div className="relative space-y-2">
                <Label htmlFor="employeeId" className="text-sm text-gray-500 font-medium">Vendor ID</Label>
              ...
              <div className="space-y-2">
              <Label htmlFor="employeeName" className="text-sm text-gray-500 font-medium">Primary Contact Name</Label>
              <Input
                id="employeeName"
            ...
            {/* Employee Name */}
            <div className="space-y-2">
              <Label htmlFor="employeeName" className="text-sm text-gray-500 font-medium">Company Name</Label>
              <Input
                id="employeeName"
            ...
            {/* Status */}
             ...
             <div className="space-y-2">
              <div className=" border-2 border-gray-100 p-2 rounded-lg space-y-3">
              <div className="text-sm mb-3 text-gray-700 font-semibold ">Other Details</div>


              <div className="relative space-y-2">
                <Label htmlFor="employeeId" className="text-sm text-gray-500 font-medium">Official Website</Label>
            ...
            {/* Employee Name */}
            <div className="space-y-2">
              <Label htmlFor="employeeName" className="text-sm text-gray-500 font-medium">Opening Balance </Label>
              <Input
                id="employeeName"
                placeholder="Full Name"
                value={formData.employeeName}
            ...
            {/* Email */}
             <div className="relative space-y-2">
              <Label htmlFor="email" className="text-sm text-gray-500 font-medium">Billing Address</Label>
              <Input
                id="email"
                type="email"
                value={formData.email}
            ...
            {/* Contact */}
             <div className="relative space-y-2">
              <Label htmlFor="contact" className="text-sm text-gray-500 font-medium">Shipping Address</Label>
              <Input
                id="contact"
                value={formData.contact}
                onChange={(e) => setFormData({ ...formData, contact: e.target.value })}
