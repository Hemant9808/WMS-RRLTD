  ...
  return (
    ...
    <div className="p-4 flex flex-col space-y-4">
      <div className="mb-3 flex justify-between items-center">
        <h2 className="font-semibold">Add Stock (Stock IN)</h2>
        <X
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <div className="space-y-2 text-xs">
                ...
                <div className="space-y-2">
                  <Label htmlFor="vendorDetail" className="text-xs font-medium">
                    Stocks In Quantiy{" "}
                  </Label>
                  <div className="flex gap-2">
                    <Input />
            ...
            <div>
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <Select
                      value={formData.vendorDetail}
                      onValueChange={(value) =>
                        setFormData({ ...formData, vendorDetail: value })
                      }
                    >
                ...
                <div className="space-y-2">
                  <Label
                    htmlFor="truckTrailerReg"
                    className="text-xs font-medium"
                  >
                    Tare Weight (Packging Weight).
                  </Label>
                  <Input
                    id="truckTrailerReg"
                    ...
                    onChange={(e) =>
                      setFormData({
                        ...formData,
                        truckTrailerReg: e.target.value,
                      })
                    }
                  />
                </div>
      ...
      <div className=" border rounded-xl ">
        ...
        <div>
          <div className=" p-4 grid sm:grid-cols-2 grid-cols-1 lg:grid-cols-4 gap-4">
            {/* Vendor Detail */}
            <div className="space-y-2">
              <Label htmlFor="vendorDetail" className="text-xs font-medium">
                Vendor Detail
            ...
            {/* Transport Company Name/Hauler */}
            <div className="space-y-2">
              <Label htmlFor="transportCompany" className="text-xs font-medium">
                Transport Company Name/Hauler
              </Label>
              <Input
                id="transportCompany"
            ...
            {/* Truck/Trailer Reg. no. */}
            <div className="space-y-2">
              <Label htmlFor="truckTrailerReg" className="text-xs font-medium">
                Truck/Trailer Reg. no.
              </Label>
              <Input
                id="truckTrailerReg"
                value={formData.truckTrailerReg}
                onChange={(e) =>
                  setFormData({ ...formData, truckTrailerReg: e.target.value })
                }
              />
            </div>
            ...
            <div className="space-y-2">
              <Label htmlFor="driverContact" className="text-xs font-medium">
                Driver Contact Number
              </Label>
              <Input
                id="driverContact"
            ...
            {/* Audited By */}
            <div className="space-y-2">
              <Label htmlFor="auditedBy" className="text-xs font-medium">
                Audited By
              </Label>
              <Input
                id="auditedBy"
                ...
                onChange={(e) =>
                  setFormData({ ...formData, auditedBy: e.target.value })
                }
              />
            </div>
            ...
            {/* Received By */}
            <div className="space-y-2">
              <Label htmlFor="receivedBy" className="text-xs font-medium">
                Received By
              </Label>
              <Select
