    ...
    <div className=" bg-white   p-4 rounded-lg">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">View and manage Stock</p>
        </div>
        <Button
      ...
      <CustomDrawer className=' w-7xl inset-y-5 inset-x-5  ' open={showAddStock} onOpenChange={setShowAddStock}>
        <AddStockModal open={showAddStock} onOpenChange={setShowAddStock} />
      </CustomDrawer>
